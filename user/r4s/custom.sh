...
git clone https://github.com/kenzok8/small-package.git          package/luci-theme-ifit
git clone https://github.com/kenzok8/small-package.git          package/luci-theme-atmaterial_new
git clone https://github.com/kenzok8/small-package.git          package/luci-theme-mcat
git clone https://github.com/kenzok8/small-package.git          package/luci-theme-neobird
git clone https://github.com/kenzok8/small-package.git          package/luci-theme-tomato